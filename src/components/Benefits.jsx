      ...
      <div className="container w-full px-5 xl:w-[80%] mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4">
          <div className="img-box text-center mx-auto">
            <Image alt="image" src={delivery} width={46} height={46} className="text-6xl text-center  mx-auto mb-5"/>
          ...
          <div className="img-box text-center mx-auto">
            <Image alt="image" src={guarantee} width={46} height={46} className="text-6xl text-center  mx-auto mb-5"/>
          ...
          <div className="img-box text-center mx-auto">
            <Image  alt="image" src={phone} width={46} height={46} className="text-6xl text-center  mx-auto mb-5"/>
          ...
          <div className="img-box text-center mx-auto">
            <Image alt="image" src={payment} width={46} height={46} className="text-6xl text-center  mx-auto mb-5"/>
